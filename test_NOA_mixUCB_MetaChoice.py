...
from generate_multilabel_data import generate_synthetic_data
from run_allucb_NOA_MetaChoice import run_mixucb   # uses the repo’s run functions
...
def plot_query_reward_expertType(
    ...
    expert_types,
    delta,
    plot_title="MetaChoice: Expert Usage Over Time"
):
    """
...
beta_meta = 3.0  # meta-rationality parameter
